...
public class GraphReader {
	...
	private static void readGraph(Graph graph, String input) {
	...
	private static void readWeightedGraph(Graph graph, Scanner input) throws DuplicateTagException {
	...
	private static void readGraph(Graph graph, Scanner input) throws DuplicateTagException {
		String u;
		String v;
		while ( input.hasNext() ) {
			u = input.next();
	...
	private static Vertex addVertex(Graph graph, String u) throws DuplicateTagException {
